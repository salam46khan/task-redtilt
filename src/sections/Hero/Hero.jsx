...
const Hero = () => {
    return (
        <div className='h-screen w-full bg-dark relative'>
            ...
            <div className="container h-full flex justify-center items-center relative">
                ...
                <div className='text-center relative z-20 p-3'>
                    <h1 className='text-4xl font-semibold text-white tablet:text-5xl desktop:text-7xl'>From Concept to Code</h1>
                    ...
                    <p className='py-3 text-slate-300 w-full text-[14px] tablet:text-[16px] max-w-md mx-auto'>
